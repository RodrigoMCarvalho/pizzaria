...
@EnableJpaRepositories(basePackages = "br.com.rodrigo.pizzaria.modelo.repositorios")
public class ConfiguracaoBD {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws Exception {
		...
		entityManagerFactoryBean.setPackagesToScan("br.com.rodrigo.pizzaria.modelo.entidades");
